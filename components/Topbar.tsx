...
export default function Topbar() {
    ...
    return (
        <section className="bg-transparent backdrop-blur-xs border border-sky-50/30 w-full pr-24 px-4 py-2 fixed top-0 left-0 z-10 content-center align-items-center text-center flex flex-1 justify-center">
