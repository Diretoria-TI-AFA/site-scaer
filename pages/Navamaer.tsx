                ...
                <div className="flex items-center justify-between w-full gap-12 bg-sky-50/40 backdrop-blur-xs border border-sky-50/35 p-6 rounded-4xl" >
                    <div className="mx-auto">
                        <svg width="100" height="250" viewBox="0 0 100 250" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0" y="90" width="100" height="160" fill="#E0E0E0" />
                            ...
                            <image x="20" y="115" width="60" height="60" href="/afa.png" />
                        </svg>
                        <p className="text-gray-200">2º Lugar</p>
                    </div>
                    <div className="mx-auto">
                        <svg width="100" height="250" viewBox="0 0 100 250" xmlns="/AMAN.png">
                            <rect x="0" y="40" width="100" height="210" fill="#FFD700" />
                            ...
                            <image x="20" y="65" width="60" height="60" href="/AMAN.png" />
                        </svg>
                        <p className="text-gray-200">1º Lugar</p>
                    </div>
                    <div className="mx-auto">
                        <svg width="100" height="250" viewBox="0 0 100 250" xmlns="/ESCOLANaval.png">
                            <rect x="0" y="140" width="100" height="110" fill="#CD7F32" />
                            ...
                            <image x="25" y="160" width="50" height="50" href="/ESCOLANaval.png" />
                        </svg>
